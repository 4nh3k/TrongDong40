...
enum custom_keycodes {
 ...
 [_LAYER0] = LAYOUT(QK_GESC,    KC_Q,       KC_W,    KC_E,    KC_R,     KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,      KC_P,      KC_LBRC,   KC_RBRC,
                    KC_TAB,     KC_A,       KC_S,    KC_D,    KC_F,     KC_G,    KC_H,    KC_J,    KC_K,    KC_L,      KC_SCLN,   KC_QUOT,   KC_ENT,
                    KC_LSFT,    KC_Z,       KC_X,    KC_C,    KC_V,     KC_B,    TG(2),   KC_N,    KC_M,    KC_COMM,   KC_DOT,    KC_SLSH,   KC_RSFT,
                    KC_LCTL,    KC_LGUI,             KC_LALT, KC_SPC,            KC_BSPC,          KC_RALT,            MO(1),             KC_RCTL),

[_LAYER1] = LAYOUT(RGB_TOG,       KC_EXLM,   KC_AT,    KC_HASH,     KC_DLR,      KC_PERC,    KC_CIRC,   KC_AMPR,  KC_ASTR,  KC_LPRN,    KC_RPRN,   KC_UNDS, KC_PLUS,
                   RGB_MOD,       KC_MS_L,   KC_MS_D,  KC_MS_U,     KC_MS_R,     KC_VOLU,    KC_MUTE,   KC_LEFT,  KC_UP,    KC_DOWN,    KC_RIGHT,  KC_BRIU,   KC_TRNS,
                   RGB_VAI,       KC_TRNS,     KC_7,     KC_WH_D,     KC_WH_U,     KC_VOLD,    KC_TRNS,   KC_F7,    KC_F8,    KC_F9,      KC_TRNS,     KC_BRID,   KC_TRNS, 
                   KC_TRNS,       KC_TRNS,               KC_TRNS,       KC_BTN1,                 KC_BTN2,             KC_PDOT,              KC_TRNS,              KC_TRNS),
 
[_LAYER2] = LAYOUT(KC_TRNS,       KC_TRNS,   KC_1,    KC_2,     KC_3,      KC_PPLS,    KC_PAST,   KC_F1,    KC_F2,    KC_F3,      KC_TRNS,     KC_TRNS,   KC_TRNS,
                   KC_TRNS,       KC_TRNS,   KC_4,    KC_5,     KC_6,      KC_PMNS,    KC_PSLS,   KC_F4,    KC_F5,    KC_F6,      KC_TRNS,     KC_TRNS,   KC_TRNS,
                   KC_TRNS,       KC_TRNS,   KC_7,    KC_8,     KC_9,      KC_PEQL,    KC_TRNS,     KC_F7,    KC_F8,    KC_F9,      KC_TRNS,     KC_TRNS,   KC_TRNS, 
                   KC_TRNS,       KC_TRNS,            KC_PCMM,  KC_0,                  QK_BOOT,             KC_PDOT,              KC_TRNS,              KC_TRNS),
[_LAYER3] = LAYOUT(KC_TRNS,       KC_TRNS,   KC_1,    KC_2,     KC_3,      KC_PPLS,    KC_PAST,   KC_F1,    KC_F2,    KC_F3,      KC_TRNS,     KC_TRNS,   KC_TRNS,
                   KC_TRNS,       KC_TRNS,   KC_4,    KC_5,     KC_6,      KC_PMNS,    KC_PSLS,   KC_F4,    KC_F5,    KC_F6,      KC_TRNS,     KC_TRNS,   KC_TRNS,
                   KC_TRNS,       KC_TRNS,   KC_7,    KC_8,     KC_9,      KC_PEQL,    KC_TRNS,     KC_F7,    KC_F8,    KC_F9,      KC_TRNS,     KC_TRNS,   KC_TRNS, 
                   KC_TRNS,       KC_TRNS,            KC_PCMM,  KC_0,                  QK_BOOT,             KC_PDOT,              KC_TRNS,              KC_TRNS) 
